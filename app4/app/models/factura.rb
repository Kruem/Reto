class Factura < ActiveRecord::Base
  validates :nombre, :presence => {:message => "Usted debe ingresar su nombre"},
   length: {minimum: 2, maximum: 50, :message => "El nombre debe tener entre 2 y 50 caracteres"}

  validates :apellido, :presence => {:message => "Usted debe ingresar su Apellido"},
   length: {minimum: 2, maximum: 50, :message => "El Apellido debe tener entre 2 y 50 caracteres"}
